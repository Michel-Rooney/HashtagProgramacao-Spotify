...
const spirit = {songName: 'S.P.I.R.I.T.', artist: 'Bring Me The Horizon', file: 's.p.i.r.i.t', liked: false}
const crawling = {songName: 'Crawling', artist: 'Linkin Park', file: 'crawling', liked: false}
const enchanted = {songName: 'Enchanted', artist: 'Taylor Swift', file: 'enchanted', liked: false}
const originalPlaylist = JSON.parse(localStorage.getItem('playlist')) ?? [spirit, crawling, enchanted];
